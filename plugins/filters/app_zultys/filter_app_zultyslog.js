/*
   Custom, Unoptimized Zultys Log to SIP/HEP3 Parser w/ reassembly of rows
...
util.inherits(FilterAppZultysLog, base_filter.BaseFilter);

FilterAppZultysLog.prototype.start = function(callback) {
logger.info('Initialized App Zultys SysLog to SIP/HEP parser');
...
FilterAppZultysLog.prototype.process = function(data) {
